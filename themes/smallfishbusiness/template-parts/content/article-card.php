...
<article <?php post_class( 'group' ); ?>>
	...
	<div class="mb-4 overflow-hidden">
		<a href="<?php the_permalink(); ?>" class="block aspect-video relative bg-gray-100">
	...
	?>
		<a href="<?php echo esc_url( get_category_link( $categories[0]->term_id ) ); ?>"
		   class="inline-block text-xs font-semibold text-primary-600 uppercase tracking-wider mb-3 hover:text-primary-700 transition-colors">
			<?php echo esc_html( $categories[0]->name ); ?>
		</a>
	<?php endif; ?>

	<!-- Title -->
	<h2 class="text-xl font-semibold mb-3 leading-snug">
	...
	<a href="<?php the_permalink(); ?>"
	   class="inline-flex items-center text-sm font-medium text-primary-600 hover:text-primary-700 transition-colors group/link">
